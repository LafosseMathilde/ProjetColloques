        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(envoyer, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void envoyerActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        try{
            if(mail.getText().isEmpty() || password.getText().isEmpty() ){
                ...
                pst=connect.connect.prepareStatement("select * from client where email=? and password=?");
                pst.setString(1, mail.getText());
                pst.setString(2, password.getText());
                rs=pst.executeQuery();
                    if (!rs.isBeforeFirst()){
                        JOptionPane.showMessageDialog(this, "Ce compte n'existe pas");
                        mail.setText("");
                        password.setText("");
                    }
                    else{
